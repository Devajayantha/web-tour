  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBank" data-dismiss="modal">Next</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalBank" tabindex="-1" role="dialog" aria-labelledby="modalBankLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalBankLabel">Payment</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="container-fluid">
            <div class="card-container">
              <div class="content-list" id="payment-list">
                <div>
                  <a class="list" href="#BNIModal" data-toggle="modal" data-target="#BNIModal" data-dismiss="modal">
                    <div class="list-payment-logo">
                      <i class="fas fa-credit-card"></i>
                    </div>
                    <div class="list-content">
                      <div class="list-title text-actionable-bold">BNI</div>
                      <div class="list-caption text-actionable-caption">Bayar dengan Kartu BNI</div>
                    </div>
                    <div class="list-next">
...
<div class="modal fade" id="BNIModal" tabindex="-1" role="dialog" aria-labelledby="BNIModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="BNIModalLabel">BNI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="BRIModal" tabindex="-1" role="dialog" aria-labelledby="BRIModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="BRIModalLabel">BRI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
